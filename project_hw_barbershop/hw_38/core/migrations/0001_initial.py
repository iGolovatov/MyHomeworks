    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новая'), ('confirmed', 'Подтвержденная'), ('cancelled', 'Отмененная'), ('completed', 'Выполненная')], default='new', max_length=50, verbose_name='Статус')),
